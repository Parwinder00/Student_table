package com.example.student_table;
        ...
        protected Void doInBackground(Void... params){
           ...
           // int InfoReceivedid = myNewIntent.getIntExtra("id");
            ...
            try{
                ...
                url = new URL("http://192.168.2.30:8080/Teacher_evaluation/cegepgim/mobile/Studentregisteration&" +InfoReceivedId +"&" +InfoReceivedfname +"&" +InfoReceivedlname +"&" +InfoReceivedphone +"&" + InfoReceivedaddress);
